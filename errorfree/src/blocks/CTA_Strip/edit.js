			...
			<InspectorControls>
				...
				>
					...
					<Color_Palette
						...
						onChange={(value) =>
							setAttributes({ button1_text_color: value })
						}
					/>
					<Color_Palette
						...
						onChange={(value) =>
							setAttributes({ button2_text_color: value })
						}
					/>
					<Color_Palette
						...
						onChange={(value) =>
							setAttributes({ button1_border_color: value })
						}
					/>
					<Color_Palette
						...
						onChange={(value) =>
							setAttributes({ button2_border_color: value })
						}
					/>

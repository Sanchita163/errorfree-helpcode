                            ...
                            {accordion.media.map((media, mediaIndex) => (
                                <div key={mediaIndex} className="media-item">
                                    ...
                                    <div className="media-right">
                                        <h4 style={{ fontSize: mediaTitleFontSize, color: mediaTitleColor, fontWeight: mediaTitleFontWeight }}>{media.title}</h4>
                                        <p style={{ fontSize: mediaDescriptionFontSize, color: mediaDescriptionColor, fontWeight: mediaDescriptionFontWeight }}>{media.description}</p>
                                    </div>
                                </div>
                            ))}
                        </div>

                            ...
                            {accordions[activeIndex].media.map((media, mediaIndex) => (
                                <div key={mediaIndex} className="media-item">
                                    ...
                                    <div className="media-right">
                                        <TextControl
                                            label={`Title for Media ${mediaIndex + 1}`}
                                            value={media.title}
                                            onChange={(newTitle) => onChangeMediaTitle(activeIndex, mediaIndex, newTitle)}
                                            style={{ fontSize: mediaTitleFontSize, color: mediaTitleColor, fontWeight: mediaTitleFontWeight }}
                                        />
                                        <TextControl
